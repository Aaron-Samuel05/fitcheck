  ...
  return (
    <>
      ...
      >
        ...
        {/* Radial neon glow */}
        <div
          className="absolute left-1/2 top-1/3 -translate-x-1/2 -translate-y-1/2 w-[620px] h-[620px] rounded-full blur-3xl opacity-40 pointer-events-none"
          style={{
            background:
              "radial-gradient(closest-side, rgba(57,255,20,0.25), rgba(57,255,20,0) 70%)",
          }}
          aria-hidden="true"
        />
        ...
        <div className="relative max-w-5xl mx-auto px-6 md:px-10 flex flex-col items-center text-center gap-8">
          ...
          >
            ...
            <span className="text-[#39FF14] neon-text">proof</span>
          ...
          >
            <button
              onClick={() => (isAuthed ? null : setAuthMode("signup"))}
              disabled={isAuthed}
